...
namespace EW12SG {
    public class GlobalData {
        ...
        public static string detailDirectory = string.Format("{0}Logdetail\\EW12SG\\", dir_Path);
        public static string singleDirectory = string.Format("{0}Logsingle\\EW12SG\\", dir_Path);
        public static string sshDirectory = string.Format("{0}Logssh\\EW12SG\\", dir_Path);
